...
export const BeautyQuizTeaser = () => {
  return (
    <section className="py-20 px-4 lg:px-8 max-w-7xl mx-auto">
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-700 text-white p-8 lg:p-14 shadow-2xl">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs font-semibold">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-cyan-300" /> Tailored Skincare & Shade Match
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-cyan-300" /> One-Click Add Regimen to Cart
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-cyan-300" /> Instant 30% Discount Code
              </div>
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-cyan-300" /> Dermatologist Formulation Rules
              </div>
            </div>
            ...
            <div className="pt-4">
              <Link
                to="/quiz"
                className="inline-flex items-center gap-3 py-4 px-8 bg-white hover:bg-cyan-300 text-gray-900 font-extrabold rounded-2xl text-xs sm:text-sm uppercase tracking-wider shadow-xl transition-all hover:scale-105 active:scale-95"
              >
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md p-6 bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl text-center space-y-4">
              <div className="w-16 h-16 rounded-2xl bg-cyan-300 text-cyan-950 flex items-center justify-center mx-auto shadow-lg">
                <Sparkles className="w-8 h-8 fill-cyan-950" />
              </div>
              <h4 className="font-serif font-bold text-xl text-white">Your Ideal Match Awaits</h4>
              <p className="text-xs text-blue-100">Over 14,000+ custom routines crafted this month.</p>
