    ...
    <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3 max-w-sm w-full px-4 pointer-events-none">
      {toasts.map((toast) => {
        ...
        return (
          <div
            key={toast.id}
            className={`pointer-events-auto flex items-start gap-3 p-4 bg-white/95 dark:bg-[#0C1733]/95 backdrop-blur-md rounded-2xl shadow-xl border ${borderColor} animate-slide-up transition-all duration-300`}
          >
