    ...
    <div className="space-y-12">
      ...
      <section className="py-16 px-4 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          ...
          {/* Filter Tabs */}
          <div className="flex items-center gap-2 bg-blue-50 dark:bg-[#070E20] p-1.5 rounded-2xl border border-blue-100 dark:border-blue-900/40 self-start md:self-auto">
            <button
              onClick={() => setActiveTab('trending')}
              className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${
                activeTab === 'trending'
                  ? 'bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-700 text-white font-extrabold shadow-md border border-blue-400/30'
