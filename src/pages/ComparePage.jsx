  ...
  return (
    <div className="pt-28 pb-20 px-4 lg:px-8 max-w-7xl mx-auto space-y-10">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <span className="text-xs font-bold text-champagne-500 uppercase tracking-widest flex items-center gap-1.5 mb-1">
        ...
        {compareItems.length > 0 && (
          <button
            ...
            className="py-2.5 px-4 bg-gray-100 dark:bg-emeraldDark-800 text-gray-600 dark:text-gray-300 font-bold rounded-2xl text-xs hover:text-rose-500 flex items-center gap-1.5"
          >
      ...
      {compareItems.length === 0 ? (
        <div className="text-center py-20 bg-white dark:bg-[#16221F] rounded-3xl border border-rose-100 dark:border-white/10 p-8 shadow-sm space-y-6">
          <div className="w-20 h-20 rounded-full bg-champagne-100 text-champagne-600 flex items-center justify-center mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {products.slice(0, 4).map((p) => (
                <button
                  ...
                  className="p-3 bg-gray-50 dark:bg-[#0B1513] rounded-2xl border border-gray-200 dark:border-white/10 text-left hover:border-champagne-500 transition-all flex flex-col items-center text-center"
                >
                  <img
                    src={p.images[0]}
                    alt={p.name}
                  ...
                  <span className="text-[10px] text-rose-500 font-semibold">+ Compare</span>
                </button>
              ))}
            </div>
          </div>
        ...
        /* Comparison Table */
        <div className="bg-white dark:bg-[#16221F] rounded-3xl border border-rose-100 dark:border-white/10 shadow-lg overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[700px]">
            <thead>
              <tr className="border-b border-rose-100 dark:border-white/10 bg-rose-50/50 dark:bg-emeraldDark-900/50">
                  ...
                  <th key={p.id} className="p-6 text-center w-64">
                    <div className="relative flex flex-col items-center">
                      <button
                        ...
                        className="absolute -top-2 -right-2 p-1.5 bg-rose-100 dark:bg-rose-950 text-rose-500 rounded-full hover:bg-rose-500 hover:text-white transition-colors"
                        title="Remove"
                      >
                      ...
                      />
                      <span className="text-[10px] uppercase font-bold text-rose-500">{p.brand}</span>
                      ...
                      <button
                        ...
                        className="w-full py-2.5 bg-rose-500 hover:bg-rose-600 text-white font-bold rounded-xl text-xs uppercase tracking-wider shadow-md transition-all flex items-center justify-center gap-1.5"
                      >
            ...
            <tbody className="divide-y divide-rose-100 dark:divide-white/5 text-xs">
              {/* Category */}
              <tr>
              ...
              <tr>
                ...
                {compareItems.map((p) => (
                  <td key={p.id} className="p-4 text-center font-medium text-rose-500">
      ...
      {compareItems.length > 0 && compareItems.length < 4 && (
        <div className="p-6 bg-white dark:bg-[#16221F] rounded-3xl border border-rose-100 dark:border-white/10 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {uncomparedProducts.slice(0, 4).map((p) => (
              <button
                key={p.id}
                onClick={() => handleSelectToCompare(p)}
                className="p-3 bg-gray-50 dark:bg-[#0B1513] rounded-2xl border border-gray-200 dark:border-white/10 text-left hover:border-champagne-500 transition-all flex items-center gap-3"
              >
                <img
                  src={p.images[0]}
                  alt={p.name}
                ...
                <div className="min-w-0">
                  ...
                  <span className="text-[10px] text-rose-500 font-bold">+ Compare</span>
                </div>
              </button>
            ))}
          </div>
